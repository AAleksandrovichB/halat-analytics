...
```
halat-analytics/
├── task_1_contribution_margin/
│   ├── contribution_margin.csv
│   ├── contribution_margin_dashboard.pbix
│   └── contribution_margin_dashboard.pdf
│
├── task_2_abc_analysis/
│   ├── ABC.csv
│   ├── ABC_dashboard.pbix
...
├── data/
│   ├── sales_clean.csv
│   ├── cost_price_clean.csv
│   └── Task.xlsx
│
├── sql/
│   └── code.sql
│
├── ABC_dashboard_preview.png
├── CM_dashboard_preview.png
└── README.md
```
